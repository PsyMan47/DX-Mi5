...
export USE_CCACHE=1
export CCACHE_DIR=/home/$USER/P.K.-MIUI/CCACHES/capricorn/.ccache
...
export LD_LIBRARY_PATH=/home/$USER/toolchain/aarch64-linux-android-5.3/lib/
export USE_CCACHE=1
export CCACHE_DIR=/home/$USER/P.K.-MIUI/CCACHES/natrium/.ccache
...
export LD_LIBRARY_PATH=/home/$USER/toolchain/aarch64-linux-android-5.3/lib/
export USE_CCACHE=1
export CCACHE_DIR=/home/$USER/P.K.-MIUI/CCACHES/lithium/.ccache
...
export LD_LIBRARY_PATH=/home/$USER/toolchain/aarch64-linux-android-5.3/lib/
export USE_CCACHE=1
export CCACHE_DIR=/home/$USER/P.K.-MIUI/CCACHES/scorpio/.ccache
...
cp $KERNEL_DIR/drivers/staging/qcacld-2.0/wlan.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/char/hw_random/msm_rng.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/char/hw_random/rng-core.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/char/rdbg.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/spi/spidev.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/input/evbug.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/crypto/ansi_cprng.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/mmc/card/mmc_test.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/video/backlight/lcd.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/video/backlight/backlight.ko $ANYKERNEL_DIR/gemini/
cp $KERNEL_DIR/drivers/video/backlight/generic_bl.ko $ANYKERNEL_DIR/gemini/
